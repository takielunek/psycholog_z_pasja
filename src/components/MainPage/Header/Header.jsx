...
const Header = () => {
  return (
    <div className="relative pt-[1000px] xxs:pt-[1090px] xss:pt-[1210px] xs:pt-[1280px] ss:pt-[1650px] sm:pt-[1580px] md:pt-[1400px] xxxl:pt-[1000px]">
      ...
      <p className="absolute top-[700px] xxs:top-[800px] xss:top-[980px] xs:top-[1050px] ss:top-[1150px] sm:top-[1200px] md:top-[1100px] xxxl:top-[740px] z-0 w-full text-center text-[14px] ss:text-[24px] font-normal tracking-[-3%] font-roboto text-gray900 px-[20px] xs:px-[50px]">
        Witaj na stronie <span className="text-blue600">Psycholog z Pasją</span>
